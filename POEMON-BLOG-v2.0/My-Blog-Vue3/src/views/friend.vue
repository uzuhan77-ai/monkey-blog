  ...
  <div class="friend-container">
    ...
    <div class="friend-wrap">
      <div class="friend-main">
            ...
            <div class="form-main shadow-box">
              ...
              <div class="envelope-content">
                ...
                <div class="envelope-footer">
                  <img
                    class="envelope-footer-img"
                    src="../assets/file/letter-3.jpg"
                  />
                </div>
        ...
        <hr />
        <h2 class="friend-thanks-title">
          <i class="fa fa-address-card"></i>特别鸣谢
        </h2>
        <card
...
const { validateRequiredWarn, validateUrl, validateLogin } =
  useFormValidation();
...
const thanksFriendList = ref([
  {
    createTime: "2023-08-13T16:14:40.021946",
    introduction: " 这是一个 Vue2 Vue3 与 SpringBoot 结合的产物～ ",
    cover:
      "https://your-qiniu-domain/friendUrl/2ae5efced1a911f0910800163e002b00",
  ...
  },
  {
    ...
    cover:
      "https://your-qiniu-domain/friendUrl/4d03fa2ed1a911f0910800163e002b00",
    friendAvatar:
      "https://your-qiniu-domain/friendAvatar/64faeed8d1ab11f0a7b800163e002b00",
    title: " 轻笑Chuckle ",
...
const submitFriend = async () => {
  ...
  try {
    await api.saveResourcePath(friend.value, false);
...
const getFriends = async () => {
  try {
    ...
    if (!$common.isEmpty(res.result[0])) {
      friendList.value = res.result[0].records;
    }
  } catch (error) {
    console.log(error);
  }

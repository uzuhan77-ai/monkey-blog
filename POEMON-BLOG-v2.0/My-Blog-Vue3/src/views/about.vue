        ...
        <div class="content-main">
          ...
          <div class="author-content">
            <div class="author-content-item myInfoAndSayHello">
              ...
              <div class="title2">
                网名
                <span class="inline-word">{{ webInfo.webName }}</span>
              </div>
              <div class="title1">
                是一只还在求学路上的
          ...
          <div class="author-content">
            ...
            <div class="author-content-item-group column mapAndInfo">
              ...
              <div class="author-content-item selfInfo myBetween single">
                <div>
                  <span class="selfInfo-title">生于</span>
                  <span class="year selfInfo-content">2002</span>
                </div>
                <div>
                  <span class="selfInfo-title">内蒙古科技大学</span>
                  <span class="software selfInfo-content">软件工程</span>
                </div>
                <div>
                  <span class="selfInfo-title">职业（2023年）</span>
                  <span class="job selfInfo-content">大三学生 👨‍🎓</span>
                </div>
                <div>
                  <span class="selfInfo-title">工作</span>
                  <span class="work selfInfo-content">金山前端打工人 🧑‍💻</span>
                </div>
              </div>
            </div>
          </div>
          <div class="author-content">
            <div class="author-content-item maxim">
              ...
              <span class="maxim-title">
                <span class="maxim-title-text">天命，</span>
                <span>不可违。</span>
              </span>
            </div>
          ...
          <div class="author-content accordion">
            <div class="author-content-item chuckle-img myCenter">
              <div class="container">
                <div
          ...
          <div class="author-content">
            <div class="author-content-item like-technology">
              <div class="card-content">
                ...
                <div class="content-bottom myBetween">
              ...
              <div class="card-content">
                ...
                <div class="content-bottom myBetween">
                  <div class="tips music-tips">
                    和 {{ webInfo.webName }} 一起欣赏更多音乐
                  </div>
                </div>
                <div class="banner-button-group">
                  <a
                    href="https://www.zjh2002.icu"
                    class="banner-button myCenter"
                  >
          ...
          <div class="about-content-item-group author-content">
          ...
          <div class="about-content-item-group author-content">
            <div class="create-site-post author-content-item single">
              <span class="disclaimer author-content-item-title"
                >🤷‍♀️免责声明</span
              >
              <br /><br />
              <p>
...
const pageView = computed(() => store.pageView);

const current = ref(0);
const images = ref($constant.about);
const total_sum = ref(pageView.value.total_sum || 0);
const yesterday_sum = ref(pageView.value.yesterday_sum);
const today_sum = ref(pageView.value.today_sum);
const user_today = ref(pageView.value.data.today.users.length);
const last_user = ref(pageView.value.data.yesterday.users.length);
    ...
    .author-content {
      ...
      .author-content-item {
        ...
        &.about-statistic {
          min-height: 380px;
          width: 39%;
          background: url(https://p.zhheo.com/l7Bfmg24690881724048986403.webp!cover)
            no-repeat top;
        ...
        &.map {
          background: url(https://your-qiniu-domain/otherPhoto/map.png)
            no-repeat center;
          min-height: 200px;
          max-height: 400px;
          position: relative;
        ...
        &.maxim {
          ...
          display: flex;
          color: var(--favoriteBg);
          background: url(https://your-qiniu-domain/otherPhoto/about1.jpg)
            no-repeat;
          background-size: cover;
          align-items: flex-start;
          flex-direction: column;
        ...
        &.myphoto {
          background: url(https://your-qiniu-domain/otherPhoto/about2.webp)
            no-repeat;
          height: 60%;
          background-size: 100%;
        ...
        &.game-lol {
          background: url(https://your-qiniu-domain/otherPhoto/%E9%95%9C.png)
            no-repeat top;
          background-size: cover;
          min-height: 300px;
          overflow: hidden;
        ...
        &.game-wolf {
          border: 1px;
          width: 56%;
          background: url(https://your-qiniu-domain/otherPhoto/%E8%A1%8C%E5%B0%B8%E8%B5%B0%E8%82%89.jpg)
            no-repeat top;
          background-size: cover;
          min-height: 300px;
          overflow: hidden;
        ...
        &.like-technology {
          border: 1px;
          background: url(https://your-qiniu-domain/otherPhoto/iphone.jpg)
            no-repeat;
          background-size: cover;
          min-height: 230px;
          color: var(--red);
        ...
        &.like-music {
          border: 1px;
          background: url(https://your-qiniu-domain/otherPhoto/Jay.webp)
            no-repeat top;
          background-size: cover;
          min-height: 400px;
          color: var(--orange1);
